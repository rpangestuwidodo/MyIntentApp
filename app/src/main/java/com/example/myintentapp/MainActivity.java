    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Bang Jago");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Bang Jago");
                mPerson.setAge(20);
                mPerson.setEmail("Bangjago@gmail.com");
                mPerson.setCity("Tangerang Selatan");
